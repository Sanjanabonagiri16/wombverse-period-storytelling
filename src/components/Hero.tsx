...
const Hero = () => {
  ...
  return (
    <section className="relative py-20 lg:py-32 overflow-hidden">
      {/* Enhanced Professional Background with Modern Colors */}
      <div className="absolute inset-0 bg-black/50"></div>
      <div className="absolute inset-0 bg-gradient-to-br from-indigo-900/40 via-black/50 to-purple-600/20"></div>
      ...
      <div className="absolute bottom-1/3 right-1/4 w-56 h-56 bg-gradient-to-r from-purple-600/25 to-indigo-500/10 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '2s' }}></div>
      <div className="absolute bottom-10 left-1/4 w-14 h-14 bg-gradient-to-br from-purple-600/25 to-indigo-400/20 rounded-full blur-2xl animate-float"></div>
        ...
        <div className="max-w-4xl mx-auto text-center">
          <div className="mb-8">
            <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-playfair font-extrabold leading-tight">
              ...
              <span className="block animate-slide-in-up opacity-0" style={{ animationFillMode: 'forwards', animationDelay: '0.4s' }}>
                <span className="bg-gradient-to-r from-purple-400 via-indigo-500 to-purple-600 bg-clip-text text-transparent drop-shadow-md">
                  Your Voice.
                </span>
              </span>
            </h1>
          ...
          <div className="animate-fade-in opacity-0 mb-12" style={{ animationFillMode: 'forwards', animationDelay: '0.6s' }}>
            <p className="text-lg md:text-xl leading-relaxed max-w-3xl mx-auto text-gray-300">
              ...
              <br />
              <span className="block mt-4 text-2xl md:text-3xl font-bold font-inter tracking-wider text-indigo-300 drop-shadow-[0_2px_4px_rgba(99,102,241,0.4)]">
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center items-center mb-16 animate-fade-in opacity-0" style={{ animationFillMode: 'forwards', animationDelay: '0.8s' }}>
            <Link to="/auth">
              <Button size="lg" className="group bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-700 hover:to-purple-700 text-white text-lg px-12 py-6 rounded-lg transition-all duration-300 hover:scale-105 hover:shadow-xl shadow-indigo-500/25 hover-glow">
            ...
            <Link to="/stories">
              <Button size="lg" variant="outline" className="group border-2 border-purple-400 text-purple-400 hover:bg-purple-400 hover:text-white text-lg px-12 py-6 rounded-lg transition-all duration-300 hover-lift">
          ...
          <div className="max-w-6xl mx-auto animate-fade-in opacity-0" style={{ animationFillMode: 'forwards', animationDelay: '1s' }}>
            <Button
              ...
              className="group bg-slate-800/80 hover:bg-purple-900/40 text-white border border-slate-600 hover:border-purple-400 mb-8 text-base px-8 py-4 rounded-lg transition-all duration-300 hover:scale-105 backdrop-blur-sm"
            >
                ...
                <div className="space-y-8">
                  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                    {displayedWisdom.map((quote, index) => (
                      <div
                        key={index}
                        className="group bg-slate-800/60 backdrop-blur-lg rounded-xl p-6 border border-slate-700 hover:border-purple-500/50 transition-all duration-300 animate-slide-in-up hover-lift opacity-0"
                        style={{ animationFillMode: 'forwards', animationDelay: `${1.2 + index * 0.08}s` }}
                      >
                        {quote.category && (
                          <div className="inline-block px-3 py-1 mb-3 text-xs font-semibold rounded-full bg-purple-500/20 border border-purple-500/30 text-purple-300">
                            {quote.category}
                          </div>
                        )}
                        ...
                        <cite className="text-indigo-400 text-sm font-semibold">
                          — {quote.author}
                        </cite>
                      </div>
                    ))}
                  ...
                  {hasMoreWisdom && (
                    <div className="text-center pt-6">
                      <Button
                        ...
                        className="bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-700 hover:to-purple-700 text-white px-8 py-3 rounded-lg transition-all duration-300 hover:scale-105"
                      >
