...
const Hero = () => {
  ...
  return (
    <section className="relative py-20 lg:py-32 overflow-hidden">
      {/* Enhanced Professional Background with Grayscale */}
      <div className="absolute inset-0 bg-womb-charcoal/50"></div>
      <div className="absolute inset-0 bg-gradient-to-br from-womb-softgray/30 via-womb-charcoal/50 to-womb-mediumgray/20"></div>
      <div className="absolute top-1/4 left-1/3 w-48 h-48 bg-gradient-to-r from-womb-mediumgray/20 to-transparent rounded-full blur-3xl animate-pulse"></div>
      <div className="absolute bottom-1/3 right-1/4 w-56 h-56 bg-gradient-to-r from-womb-softgray/25 to-womb-mediumgray/10 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '2s' }}></div>
      <div className="absolute bottom-10 left-1/4 w-14 h-14 bg-gradient-to-br from-womb-softgray/25 to-womb-mediumgray/20 rounded-full blur-2xl animate-float"></div>
      <div className="absolute top-16 right-1/4 animate-float opacity-20" style={{ animationDelay: '1s' }}>
        <Heart className="w-8 h-8 text-womb-softgray" />
      </div>
      <div className="absolute bottom-32 left-1/4 animate-float opacity-15" style={{ animationDelay: '3s' }}>
        <Star className="w-6 h-6 text-womb-mediumgray" />
      </div>
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          <div className="mb-8">
            <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-playfair font-extrabold leading-tight">
              <span className="block animate-slide-in-up opacity-0" style={{ animationFillMode: 'forwards', animationDelay: '0.1s' }}>
                <span className="text-womb-lightgray drop-shadow-md">
                  Your Period.
                </span>
              </span>
              <span className="block animate-slide-in-up opacity-0" style={{ animationFillMode: 'forwards', animationDelay: '0.25s' }}>
                <span className="bg-gradient-to-r from-womb-mediumgray via-womb-softgray to-womb-mediumgray bg-clip-text text-transparent drop-shadow-lg">
                  Your Story.
                </span>
              </span>
              <span className="block animate-slide-in-up opacity-0" style={{ animationFillMode: 'forwards', animationDelay: '0.4s' }}>
                <span className="bg-gradient-to-r from-womb-softgray via-womb-mediumgray to-womb-softgray bg-clip-text text-transparent drop-shadow-md">
                  Your Voice.
                </span>
              </span>
            </h1>
          ...
          <div className="animate-fade-in opacity-0 mb-12" style={{ animationFillMode: 'forwards', animationDelay: '0.6s' }}>
            <p className="text-lg md:text-xl leading-relaxed max-w-3xl mx-auto text-womb-secondarytext">
              Join a community where period stories are shared, celebrated, and heard.
              <br />
              <span className="block mt-4 text-2xl md:text-3xl font-bold font-inter tracking-wider text-womb-mediumgray drop-shadow-[0_2px_4px_rgba(176,176,176,0.4)]">
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center items-center mb-16 animate-fade-in opacity-0" style={{ animationFillMode: 'forwards', animationDelay: '0.8s' }}>
            <Link to="/auth">
              <Button size="lg" className="group bg-gradient-to-r from-womb-mediumgray to-womb-softgray hover:from-gray-500 hover:to-gray-400 text-womb-charcoal text-lg px-12 py-6 rounded-lg transition-all duration-300 hover:scale-105 hover:shadow-xl shadow-gray-600/25 hover-glow">
            ...
            <Link to="/stories">
              <Button size="lg" variant="outline" className="group border-2 border-womb-softgray text-womb-softgray hover:bg-womb-softgray hover:text-womb-charcoal text-lg px-12 py-6 rounded-lg transition-all duration-300 hover-lift">
          ...
          <div className="max-w-6xl mx-auto animate-fade-in opacity-0" style={{ animationFillMode: 'forwards', animationDelay: '1s' }}>
            <Button
              ...
              className="group bg-womb-darkgray/80 hover:bg-womb-softgray/40 text-womb-lightgray border border-womb-border hover:border-womb-softgray mb-8 text-base px-8 py-4 rounded-lg transition-all duration-300 hover:scale-105 backdrop-blur-sm"
            >
              <Heart className="w-5 h-5 mr-3 text-womb-softgray" />
                ...
                <div className="space-y-8">
                  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                    {displayedWisdom.map((quote, index) => (
                      <div
                        key={index}
                        className="group bg-womb-darkgray/60 backdrop-blur-lg rounded-xl p-6 border border-womb-border hover:border-womb-softgray/50 transition-all duration-300 animate-slide-in-up hover-lift opacity-0"
                        style={{ animationFillMode: 'forwards', animationDelay: `${1.2 + index * 0.08}s` }}
                      >
                        {quote.category && (
                          <div className="inline-block px-3 py-1 mb-3 text-xs font-semibold rounded-full bg-womb-softgray/20 border border-womb-softgray/30 text-womb-softgray">
                            {quote.category}
                          </div>
                        )}
                        <blockquote className="text-womb-secondarytext text-sm md:text-base mb-3 leading-relaxed italic">
                          "{quote.text}"
                        </blockquote>
                        <cite className="text-womb-mediumgray text-sm font-semibold">
                          — {quote.author}
                        </cite>
                      </div>
                    ))}
                  ...
                  {hasMoreWisdom && (
                    <div className="text-center pt-6">
                      <Button
                        ...
                        className="bg-gradient-to-r from-womb-mediumgray to-womb-softgray hover:from-gray-500 hover:to-gray-400 text-womb-charcoal px-8 py-3 rounded-lg transition-all duration-300 hover:scale-105"
                      >
