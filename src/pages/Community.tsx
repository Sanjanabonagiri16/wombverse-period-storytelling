  ...
  return (
    <Layout>
      <div className="container mx-auto px-4 py-8 max-w-6xl">
        <div className="mb-6 lg:mb-8 bg-gradient-to-r from-womb-maroon via-womb-black to-womb-indigo rounded-xl p-6 shadow-lg border border-womb-maroon/20">
          <h1 className="text-3xl md:text-4xl font-playfair font-bold text-white mb-3 leading-tight">
            Community Wall <span className="text-womb-indigo">🤝</span>
          </h1>
