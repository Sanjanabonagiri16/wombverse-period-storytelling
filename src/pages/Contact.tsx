  ...
  <Layout>
    <div className="container mx-auto px-4 py-16">
      <div className="max-w-4xl mx-auto text-center">
        <h1 className="text-4xl md:text-5xl font-bold text-white mb-4 font-playfair">Get in Touch</h1>
      ...
      <div className="grid md:grid-cols-2 gap-12 items-start max-w-5xl mx-auto">
        <div className="bg-womb-deepgrey border maroon-border rounded-lg p-8 space-y-6">
          <h2 className="text-2xl font-bold text-white font-playfair">Contact Information</h2>
        ...
        <div className="bg-womb-deepgrey border maroon-border rounded-lg p-8">
          <h2 className="text-2xl font-bold text-white font-playfair mb-6">Send a Message</h2>
          <form className="space-y-4">
            <div>
              <label htmlFor="name" className="block text-sm font-medium text-white mb-1">Full Name</label>
              <Input id="name" placeholder="Your Name" className="bg-womb-charcoal border-womb-deepgrey text-white" />
            </div>
            <div>
              <label htmlFor="email" className="block text-sm font-medium text-white mb-1">Email Address</label>
              <Input id="email" type="email" placeholder="you@example.com" className="bg-womb-charcoal border-womb-deepgrey text-white" />
            </div>
            <div>
              <label htmlFor="message" className="block text-sm font-medium text-white mb-1">Message</label>
              <Textarea id="message" placeholder="Your message..." rows={5} className="bg-womb-charcoal border-womb-deepgrey text-white" />
            </div>
